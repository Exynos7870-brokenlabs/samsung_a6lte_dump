...
cat system/system/priv-app/StickerFaceAR/StickerFaceAR.apk.* 2>/dev/null >> system/system/priv-app/StickerFaceAR/StickerFaceAR.apk
rm -f system/system/priv-app/StickerFaceAR/StickerFaceAR.apk.* 2>/dev/null
